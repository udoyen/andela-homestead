...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        print "You up and run to the far side of the room and find the"
        print "neutron bomb in its container. There's s keypad lock on the box"
        print "and you need the code to get the bomb out. If you get the code"
        print "wrong 10 times then the lock closes forever and you can't"
        print "set the bomb. The code is 3 digits."
        ...
        if guess == code:
            ...
            print "ship from their ship and yu die."
            return 'death'
